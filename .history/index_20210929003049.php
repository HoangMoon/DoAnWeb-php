				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					?>
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="chitietsp.php?id=<?php echo $row_category_danhmuc['category_id']?>" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="chitietsp.php?id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Xem sản phẩm</a>
												</div>
											</div>
										</div>
						...
						while($row_category_sidebar = mysqli_fetch_array($sql_category_sidebar)) {
							?>
								<li>
									...
									<span class="span"><a href="danhmucsanpham.php?id=<?php echo $row_catetgory_sidebar['category_id'] ?>"><?php echo $row_category_sidebar['category_name'] ?></a></span>
								</li>
								<?php
									}
								?>
