...
<?php
  if(isset($_POST['dangnhap_home'])) {
    ...
    if($taikhoan== "" || $matkhau=="") {
      ...
      $sql_select_admin = mysqli_query($con, "SELECT * FROM tbl_login WHERE email_login = '$taikhoan' AND password = '$matkhau' LIMIT 1");
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white d-flex">
