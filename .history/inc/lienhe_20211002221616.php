...
<div class="contact py-sm-5 py-4">
      ...
      <form action="" method="POST" enctype="multipart/form-data" >
          <div class="form-group">
            ...
            <input type="email" class="contact-form orm-control" name="email" placeholder="Email" />
          </div>
          <div class="form-group">
            <input type="text" class="contact-form orm-control" name="phone" placeholder="SDT" />
            <input type="text" class="contact-form orm-control" name="adress" placeholder="Địa chỉ" />
          </div>
          <div class="form-group">
            <textarea name="write" id="" cols="30"  rows="10"></textarea>
          </div>
          <button type="submit" name="submit-contact" class="btn-contact">Gửi</button>
        </form>
			<!-- //form -->
		</div>
	</div>
