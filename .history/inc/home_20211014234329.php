															...
															?>
																...
																if($row_yeuthich['sanpham_yeuthich']!=0) {
																	...
																	while($i < $row_yt1['YT']) {
																		$i++;
																	?>	
																	<a style="color:#3D6EF7" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=<?php echo $i++ ?>"><i class="fa fa-heart-o icon-heart" style="color: red;" aria-hidden="true">
																</i>
																</a>
																<?php
																	}
