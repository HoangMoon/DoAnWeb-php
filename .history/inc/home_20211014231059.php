													...
													<div class="btn-buy">
														...
														<div class="social-cart">
															<?php
																...
																while($i < $row_yeuthich = mysqli_fetch_array($sql_yt)) {
																	$row_yeuthich['sanpham_yeuthich'] = $i++;
															?>
																<?php
																if($row_yeuthich['sanpham_yeuthich']==0) {
																	?>	
																	<a style="color: #ccc;" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=<?php echo $i++ ?>"><i class="fa fa-heart-o icon-heart" style="color: #ccc;" aria-hidden="true">
																</i>
																</a>
																	<?php
																}
																	...
																	?>	
																<a style="color: red;" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=<?php echo $i++ ?>"><i class="fa fa-heart-o icon-heart" style="color: red;" aria-hidden="true"></i>
																</a>
																	<?php
																}
																?>
