<?php 
	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<!-- //tittle heading -->
            <?php
                    $sql_baiviet = mysqli_query($con,"SELECT * FROM tbl_danhmuc_tin,tbl_baiviet WHERE tbl_danhmuc_tin.danhmuctin_id = tbl_baiviet.danhmuctin_id AND tbl_danhmuc_tin.danhmuctin_id = '$danhmuc'");
			...
			<div class="row">
                ...
                <div class="col-lg-8 welcome-left">
					<h5><a <?php echo $row_baiviet['baiviet_id'] ?>"><?php echo $row_baiviet['tenbaiviet']?></a> </h5>
