					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row product-row">
								<?php
									$sql_product = mysqli_query($con, "SELECT * FROM tbl_sanpham,tbl_donhang WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id ORDER BY tbl_sanpham.sanpham_id DESC");
