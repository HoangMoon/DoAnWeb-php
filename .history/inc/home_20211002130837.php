									...
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<?php 
												...
												$sql_daban = mysqli_query($con, "SELECT mahang FROM tbl_donhang");
												// $i = 0;
													while($row_ban = mysqli_fetch_array($sql_soluongban, $sql_daban)){
														if($row_ban['sanpham_id'] == $sanpham_id && $row_ban['mahang']) {
											?>
											<?php
												if($row_ban['mahang']) {
													?>
													<span class="number-buy" style="font-size: 14px">
															Đã bán <?php echo $row_ban['daban']?> sp
												</span>
												<?php
												}
												else {
