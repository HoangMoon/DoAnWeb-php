														...
														<div class="social-cart">
															...
															?>
																...
																if($row_yeuthich['sanpham_yeuthich']==0) {
																	?>
																	<a style="color: #ccc;" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
																	<?php
																}
																else {
																	?>	
																	<a style="color: red;" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>"><i class="fa fa-heart-o" style="color: red;" aria-hidden="true"></i></a>
																	<?php
																}
																?>
															<?php
