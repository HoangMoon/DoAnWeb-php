<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
      ...
      <?php
        ...
        $sql_select = mysqli_query($con, "SELECT * , SUM(tbl_donhang.soluong*tbl_sanpham.sanpham_giakhuyenmai) AS 'tongtien'  FROM tbl_giaodich ,tbl_sanpham, tbl_donhang WHERE tbl_giaodich.sanpham_id = tbl_sanpham.sanpham_id AND tbl_giaodich.khachhang_id = '$id_khach' AND tbl_donhang.khachhang_id = tbl_giaodich.khachhang_id GROUP BY tbl_giaodich.magiaodich DESC");
      ?>
        <table class="table table-bordered">
          <tr style="text-align:center">
            <th>STT</th>
