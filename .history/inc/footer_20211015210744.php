	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2021 HH Store. Bản quyền sỡ hữu | Design by Huy Hoàng
	...
	<?php
		...
		$sql_sanpham = mysqli_query($con, "SELECT * FROM tbl_donhang , tbl_sanpham, tbl_khachhang WHERE tbl_sanpham.sanpham_id = tbl_donhang.sanpham_id AND tbl_khachhang.khachhang_id = tbl_donhang.khachhang_id and tbl_donhang.sanpham_id = '$sanpham_id'");
		while($row_noti = mysqli_fetch_array($sql_sanpham)) {
	?>
	 <div class="noti d-flex ">
        <img src="<?php echo $row_noti['sanpham_image'] ?>" alt=" " class="noti-image ">
