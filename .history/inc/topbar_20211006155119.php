...
<?php
  if(isset($_POST['dangnhap_home'])) {
    ...
    if($taikhoan== "" || $matkhau=="") {
      ...
      if($count > 0) {
        $_SESSION['dangnhap_home'] = $row_dangnhap['username'];
        $_SESSION['id_login'] = $row_dangnhap['id_dangnhap'];
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&email=<?php echo $_SESSION['em_donhang'] ?>" class="text-white d-flex">
	...
	<div class="modal fade" id="dangky" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
            ...
            <div class="form-control">
                ...
                <input type="email" name="phone" id="email" placeholder="huyhoang@gmail.com">
            </div>
						<div class="form-control">
                <label for="#">Địa chỉ</label>
                <input type="email" name="address" id="email" placeholder="huyhoang@gmail.com">
            </div>
            <div class="form-control">
            ...
            <div class="form-control">
                <textarea class="form-control" name="note">Ghi chú</textarea>
            </div>
