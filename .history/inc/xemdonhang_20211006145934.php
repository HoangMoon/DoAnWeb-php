<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
      ...
      if(isset($_GET['xemdonhang'])) {
        $email_dh = $_GET['xemdonhang'];
      }
      else {
        $email_dh = '';
      }
        $sql_select = mysqli_query($con, "SELECT *,  SUM(tbl_donhang.soluong*tbl_sanpham.sanpham_giakhuyenmai) AS 'tongtien' FROM tbl_donhang, tbl_sanpham WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id AND tbl_khachhang.email = tbl_donhang.email");
      ?>
