														...
														<div class="social-cart">
															...
															?>
																...
																if($row_yeuthich['sanpham_yeuthich']==0) {
																	?>	
																	<a style="color: #ccc;" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=1"><i class="fa fa-heart-o icon-heart" style="color: red;" aria-hidden="true"></i></a>
																	<?php
																}
																else {
																	?>	
