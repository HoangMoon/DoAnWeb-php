...
if(isset($_POST['thanhtoan'])) {
	...
	$sql_khachhang = "INSERT INTO tbl_khachhang(name,phone , email, address, note, giaohang) VALUES ('$name','$phone','$email', '$address','$note', '$giaohang')";
						...
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="controls form-group">
										<textarea class="form-control" name="email" id="" placeholder="Ghi chú" name="note" require=""></textarea>
									</div>
									<div class="controls form-group">
