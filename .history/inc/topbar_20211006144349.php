...
?>
<?php
	$sql_khachhang = mysqli_query($con, "SELECT * FROM tbl_khachhang , tbl_login");
	$row_kh = mysqli_fetch_array($sql_khachhang);
	// $_SESSION['id_khachhang'] = $row_kh['khachhang_id'];
?>
	<!-- top-header -->
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang" class="text-white d-flex">
