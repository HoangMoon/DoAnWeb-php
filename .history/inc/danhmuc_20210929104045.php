<?php
	if(isset($_GET['id'])) {
		...
		$sql_cate = mysqli_query($con, "SELECT * FROM tbl_category,tbl_sanpham WHERE tbl_category.category_id = tbl_sanpham.category_id AND tbl_sanpham.category_id = '$id' ORDER BY tbl_sanpham.sanpham_id category_id DESC");
								...
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>">Samsung Galaxy J7</a>
											</h4>
