<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
      ...
      <?php
        ...
        $sql_select = mysqli_query($con, "SELECT *  WHERE tbl_giaodich.sanpham_id = tbl_sanpham.sanpham_id AND tbl_giaodich.magiaodich = '$magiaodich' AND tbl_donhang.khachhang_id = tbl_giaodich.khachhang_id and tbl_sanpham.sanpham_id = tbl_donhang.sanpham_id");
      ?>
        <table class="table table-bordered">
          <tr style="text-align:center">
            <th>STT</th>
