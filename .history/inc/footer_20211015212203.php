	...
	<?php
		...
		$sql_sanpham = mysqli_query($con, "SELECT * FROM tbl_donhang , tbl_sanpham, tbl_khachhang WHERE tbl_sanpham.sanpham_id = tbl_donhang.sanpham_id AND tbl_khachhang.khachhang_id = tbl_donhang.khachhang_id WHERE tbl_sanpham.sanpham_id = '$sanpham_id'");
