...
if(isset($_POST['thanhtoan'])) {
	...
	if($sql_khachhang) {
		...
		for($i=0; $i<count($_POST['thanhtoan_product_id']); $i++) {
			...
			$sql_donhang = mysqli_query($con,"INSERT INTO tbl_donhang(sanpham_id, khachhang_id, soluong, mahang, email) VALUES ('$sanpham_id', '$khachhang_id','$soluong','$mahang', '$email')");
				...
				<div class="table-responsive">
					...
					<table class="timetable_sub" style="width: 98%">
						...
						<tbody>
							...
							<tr>
							<td colspan="6"><input type="submit" class ="btn btn-primary"  value="Cập nhật giỏ hàng" name="capnhatsoluong"></td>
							<?php
							...
							{
							?>
							<td colspan="0"><input type="submit" class ="btn btn-primary"  value="Thanh toán giỏ hàng" name="thanhtoandangnhap"></td>
							<?php
							}
							?>
							</tr>
