								...
								<div class="col-md-4 product-men mt-5 product-item">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<?php 
												$sql_soluongban = mysqli_query($con,"SELECT mahang, SUM(tbl_donhang.soluong) AS 'daban'  FROM tbl_donhang" );
												$_count = mysqli_num_rows($sql_soluongban);
													while($row_ban = mysqli_fetch_array($sql_soluongban)){
														if($row_ban['mahang'] == $sanpham_id && $row_sanpham['sanpham_id'] = $sanpham_id) {
											?>
