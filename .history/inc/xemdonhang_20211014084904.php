        ...
        <table class="table table-bordered">
          ...
          ?>
            <tr style="text-align:center">
              ...
              <td><a class="btn btn-primary" href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich']  ?>">Hủy đơn hàng</a></td>
