...
<?php 
	...
	if($update_yt) {
		echo '<script>alert("Cảm ơn bạn đã yêu thích sản phẩm!")</script>';
	}
	unset('Location : index.php?id=&id='.$sanpham_id&yeuthich=.$sanpham_yeuthich');
?>
<!-- top Products -->
														...
														<div class="social-cart">
															...
															?>
																...
																if($row_yeuthich['sanpham_yeuthich']==0) {
																	?>	
																	<a style="color: #ccc;" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=1"><i class="fa fa-heart-o icon-heart" style="color: #ccc;" aria-hidden="true"></i></a>
																	<?php
																}
																else {
																	?>	
																	<a style="color: red;" href="index.php?id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=1"><i class="fa fa-heart-o" style="color: red;" aria-hidden="true"></i></a>
																	<?php
																}
																?>
															<?php
