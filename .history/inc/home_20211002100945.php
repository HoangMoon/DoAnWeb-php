								...
								<div class="col-md-4 product-men mt-5 product-item">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<?php 
												$sql_soluongban = mysqli_query($con,"SELECT * FROM tbl_donhang, tbl_sanpham WHERE tbl_sanpham.sanpham_id = tbl_donhang.sanpham_id ORDER BY tbl_donhang.donhang_id DESC" );
											...
											?>
												...
												<?php
													...
													if($row_ban['sanpham_id'] == $row_ban['sanpham_id'] && $row_ban['soluong'] >= 1) {
														?>
															<span>Đã bán <?php echo $row_ban['soluong']+$row_ban['soluong'] ?> sp</span>
														<?php
													}
													else {
														?>
