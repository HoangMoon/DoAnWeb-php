															...
															?>
																...
																if($row_yeuthich['sanpham_yeuthich']!=0) {
																	...
																	while($i < $counthh) {
																		$i++;
																	?>
																		<a style="color:#3D6EF7" class="icon-heart" href="?index.php&id=<?php echo $row_yeuthich['sanpham_id'] ?>&yeuthich=<?php echo ?>">
																		<i class="fa fa-heart-o icon-heart" style="color:#3D6EF7;" aria-hidden="true">
																</i>
																</a>	
																<?php
																	}
