					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								...
								?>
										<input type="number" name="thanhtoan_soluong[]" id="" value="<?php echo $row_fetch_giohang['soluong']  ?>">
										<input type="hidden" name="thanhtoan_product_id[]" value="<?php echo $row_fetch_giohang['sanpham_id']  ?>">
								<?php
									}
								?>
