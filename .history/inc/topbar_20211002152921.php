	...
	<div class="modal fade" id="dangky" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
            ...
            <div class="form-control">
                ...
                <input type="password" name="password" id="password2" placeholder="Password two">
                <i class="fa fa-eye icon-eye" aria-hidden="true"></i>
                <small class="error-txt">Error message</small>
            </div>

            <input type="submit" name="dangky" class="login__button btn btn-primary" value="Đăng ký">
        </form>
				</div>
			</div>
		</div>
