					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row product-row">
								<?php
									$sql_product = mysqli_query($con, "SELECT * FROM tbl_sanpham,tbl_giohang WHERE tbl_giohang.sanpham_id = tbl_sanpham.sanpham_id ORDER BY tbl_sanpham.sanpham_id DESC");
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="star-buy flex">
												...
												<span class="number-buy">
													Đã bán<?php echo $row_sanpham['sanpham_soluong']-$row_sanpham['soluong'] ?> sản phẩm
												</span>
											</div>
