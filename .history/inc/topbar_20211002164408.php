...
?>
	...
	<div class="modal fade" id="dangky" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
            ...
            <!-- <button  type="submit"><input type="submit" style="width: 100%" name="dangky" class="login__button btn btn-primary" value="Đăng ký"></button> -->
						<button class="btn btn-primary" type="submit" name="Đăng ký">Đăng ký</button>
        </form>
				</div>
			</div>
		</div>
