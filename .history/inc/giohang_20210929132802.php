<?php
	if(isset($_POST['themgiohang'])) {
		...
		$sql_giohang = mysqli_query($con, "INSERT INTO tbl_giohang(tensanpham, sanpham_id, giasanpham, hinhanh, soluong) VALUES ('$tensanpham','$sanpham_id','$hinhanh','$gia','$hinhanh','$soluong')");
