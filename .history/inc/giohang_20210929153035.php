					...
					<table class="timetable_sub">
						...
						<tbody>
							...
							<tr class="rem1">
								...
								<td class="invert">
									<input type="number" name="soluong" id="" min="1" value="<?php echo $row_fetch_giohang['soluong']  ?>">
								</td>
								...
								<td class="invert">
									<div class="rem">
										<div class="close1" style="right: 0;"> </div>
									</div>
								</td>
							</tr>
							<?php
							...
							<tr>
							<td colspan="7"><input type="submit" value="Cập nhật giỏ hàng" name="capnhatsoluong"></td>
							</tr>
						</tbody>
					</table>
				</div>
