...
<?php 
	if(isset($_POST['dangky'])) {
      ...
      echo '<script>alert("Bạn hãy nhập đủ thông tin")</script>';
     	...
     	$sql_login = mysqli_query($con, "INSERT INTO `tbl_login`(`username`, `email_login`, `password`) VALUES ('$user','$email','$password')");
    }
	}
?>
<!DOCTYPE html>
...
let counterValue = parseInt(list.textContent);
plusBtn.addEventListener("click", function (e) {
  counterValue++;
  list.textContent = counterValue;
});
