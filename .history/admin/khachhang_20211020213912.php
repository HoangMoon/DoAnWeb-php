...
?>
<?php
  $sql_dete = mysqli_query($con, "SELECT * FROM tbl_giaodich");
  $row_huydon = mysqli_fetch_array($sql_dete);
  if($row_huydon['huydon']== 1) {
  $sql_dete = mysqli_query($con, "DELETE * FROM tbl_giaodich WHERE huydon = '1'");
  }
?>
<!DOCTYPE html>
<html lang="en">
