        ...
        <div class="right_col" role="main">
          <div class="row">
            <div class="statistical">
              ...
              ?>
              <?php 
                $sql_doanhthu = mysqli_query($con, "SELECT * FROM tbl_donhang,tbl_sanpham WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id");
                $total = 0;
                while($row_dt = mysqli_fetch_array($sql_doanhthu)) {
                  $subtotal = $row_dt['tbl_donhang.soluong'] * $row_dt['sanpham_giakhuyenmai'];
									$total += $subtotal;
              ?>
