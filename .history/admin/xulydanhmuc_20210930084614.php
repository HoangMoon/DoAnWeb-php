      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr>
            ...
            <td style="width: 200px"><a href="?xoa=<?php echo $row_category['category_id'] ?>" class="btn btn-danger">Xóa</a> <a href="?capnhat=<?php echo $row_category['category_id'] ?>" class="btn btn-warning">Cập nhật</a></td>
          </tr>
          <?php
          }
          ?>
