...
">
    <form action="" method="POST" class="login__create">
        ...
        <span>Chưa có tài khoản ?<a href="">Đăng ký admin</a></span>
    </form>

    <form action="#" class="form none" id="form" autocomplete="off">
            <div class="form-control2">
                <label for="#">User name</label>
                <input type="text" name="" id="username" placeholder="huyhoang0508">
            ...
            <div class="form-control2">
                ...
                <input type="email" name="" id="email" placeholder="huyhoang@gmail.com">
                <i class="fa fa-check icon-check"></i>
                <i class="fa fa-exclamation icon-ex" aria-hidden="true"></i>
                <small class="error-txt">Error message</small>
            </div>
