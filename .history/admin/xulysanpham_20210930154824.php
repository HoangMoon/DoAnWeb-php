...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
      ...
      <!-- <?php
        $sql_select_sp = mysqli_query($con, "SELECT * FROM tbl_sanpham, tbl_category WHERE tbl_sanpham.category_id = tbl_category.category_id  ORDER BY sanham_id DESC");
      ?> -->
      <table class="table table-bordered">
        ...
        ?>
          <tr>
            ...
            <td><img src="../uploads/<?php echo $row_sanpham['sanpham_image']?>" width="80" height="80" alt=""></td>
            ...
            <td style="text-align: center;"><a style="font-size: 14px;width: 100px;" href="?xoa=<?php echo $row_sanpham['sanpham_id'] ?>" class="btn btn-danger">Xóa</a> <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sanpham['sanpham_id'] ?>" style="width: 100px; font-size: 14px" class="btn btn-warning">Cập nhật</a></td>
          </tr>
          <?php
          }
          ?>
