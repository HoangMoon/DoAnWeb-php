      ...
      <table class="table table-bordered">
        ...
        ?> -->
          <tr>
            ...
            <td style="text-align: center;"><a style="font-size: 14px;width: 100px;" href="?xoa=<?php echo $row_donhang['sanpham_id'] ?>" class="btn btn-danger">Xóa</a> <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_donhang['sanpham_id'] ?>" style="width: 100px; font-size: 14px" class="btn btn-primary">Xem đơn hàng</a></td>
          </tr>
          <?php
          }
          ?>
