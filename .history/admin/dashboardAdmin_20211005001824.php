        ...
        <div class="right_col" role="main">
          <div class="row">
            <div class="statistical">
              ...
              ?>
              <?php 
                $sql_doanhthu = mysqli_query($con, "SELECT SUM(soluong*giasanpham) AS 'doanhthu' FROM tbl_donhang,tbl_sanpham WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id");
                while($row_dt = mysqli_fetch_array($sql_doanhthu)) {
              ?>
              <div class="list-statis money-total">
              <i class="fa fa-line-chart" aria-hidden="true"></i>
              <div class="feed-number">
                <span class="number-txt"><?php echo $row_dk['doanhthu'] ?></span>
