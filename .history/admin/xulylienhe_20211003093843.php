      ...
      <?php 
        if(isset($_GET['quanly'])=='lienhe') {
          ...
          <div class="form-group col-md-12">
            <input type="text" style="width: calc(50% - 15px)" name="email" class="form-control" id="" placeholder="Email...">
            <input type="text" name="subject"  style="width: calc(50% - 15px)"  class="form-control" id="" placeholder="Tiêu đề">
          </div>
          <br>
          <div class="form-group col-md-12">
