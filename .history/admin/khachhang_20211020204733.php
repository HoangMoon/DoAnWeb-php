...
<td style="text-align: center;"><a href="?quanly=xemgiaodich&khachhang=<?php echo $row_khachhang['magiaodich'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xem giao dịch</a></td>
<td style="text-align: center;"><a href="?quanly=xemgiaodich&khachhang=<?php echo $row_khachhang['magiaodich'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xóa</a></td>
            </tr>
            <?php
            }
            ?>
