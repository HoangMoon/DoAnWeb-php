      ...
      <?php 
        if(isset($_GET['quanly'])=='lienhe') {
          ...
          <div class="form-group col-md-12">
            <input type="text"  name="email" class="form-control col-md-5 mr-3" id="" placeholder="Email...">
            <input type="text" name="subject" class="form-control col-md-7" id="" placeholder="Tiêu đề">
          </div>
          <br>
          <div class="form-group col-md-12">
