 ...
 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="./khachhang.php"><i class="fa fa-table"></i> Quản lý khách hàng<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Quản lý tin tức<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href=""><i class="fa fa-desktop"></i> Quản lý liên hệ <span class="fa fa-chevron-down"></span></a>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
