      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr>
            ...
            <td style="text-align: center;"><a style="font-size: 14px;width: 100px;" href="?xoa=<?php echo $row_sanpham['sanpham_id'] ?>" class="btn btn-danger">Xóa</a> <a href="" style="width: 100px; font-size: 14px" class="btn btn-warning">Cập nhật</a></td>
          </tr>
          <?php
          }
          ?>
