...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <div class="row">
      ...
      <?php
        $sql_select = mysqli_query($con, "SELECT *  FROM tbl_donhang, tbl_sanpham, tbl_khachhang WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id AND tbl_khachhang.khachhang_id = tbl_donhang.khachhang_id  GROUP BY tbl_donhang.mahang DESC");
      ?>
        <table class="table table-bordered">
          <tr style="text-align:center">
            <th>STT</th>
