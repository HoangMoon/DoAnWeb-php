        ...
        <table class="table table-bordered">
          ...
          ?>
            <tr style="text-align:center">
              ...
              <td style="text-align: center;"><a style="font-size: 14px;display:block;" href="?xoa=<?php echo $row_donhang['donhang_id'] ?>" class="btn btn-danger mb-2">Xóa</a> <a href="?quanly=xemdonhang&mahang=<?php echo $row_donhang['mahang'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xem tài khoản</a></td>
            </tr>
            <?php
            }
            ?>
