      ...
      <table class="table table-bordered">
        ...
        ?> -->
          <tr>
            ...
            <td style="text-align: center;"><a style="font-size: 14px;display:block" href="?xoa=<?php echo $row_donhang['sanpham_id'] ?>" class="btn btn-danger">Xóa</a> <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_donhang['sanpham_id'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xem đơn hàng</a></td>
          </tr>
          <?php
          }
          ?>
