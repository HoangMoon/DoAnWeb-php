...
">
    ...
    <form action="index.php" method="POST" class="form none logout" id="form1">
            ...
            <input type="button" name="dangky" class="sub-form" value="Đăng ký">Submit</input>
        </form>
...
<?php 
  if(isset($_POST['name']) && ($_POST['email1']) && ($_POST['password1'])) {
    $name = $_POST['name'];
    $email1 = $_POST['email1'];
    $password1 = md5($_POST['password1']);
    
    echo '<script type="text/javascript">   checkInputs()    </script>';
