...
<?php
  if(isset($_POST['themsanpham'])) {
    ...
    $mota = $_POST['mota'];
    $path = '../uploads/';
    $sql_insert_product = mysqli_query($con, "INSERT INTO tbl_sanpham(sanpham_name, sanpham_chitiet, sanpham_mota, sanpham_gia, sanpham_khuyenmai, sanpham_soluong, sanpham_image, category_id) VALUES  ('$tensanpham, '$chitiet', '$mota','$gia','$giakhuyenmai','$','$soluong','$hinhanh','$danhmuc')");
