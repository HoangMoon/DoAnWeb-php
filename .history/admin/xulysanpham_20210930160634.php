           ...
           <div class="col-md-4">
            ...
            <form action="" method="POST" enctype='multipart/form-data'>
             <label for="">Tên sản phẩm</label>
              ...
              <br>
              <label for="">Giá</label>
              <input type="text" name="giasanpham" class="form-control" value="<?php echo number_format($row_capnhat['sanpham_name']).'vnd' ?>>
              <br>
              <label for="">Giá khuyến mãi</label>
              <input type="text" name="giakhuyenmai" class="form-control" value="<?php echo number_format($row_capnhat['sanpham_name']).'vnd' ?>>
              <br>
