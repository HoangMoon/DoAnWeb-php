        ...
        <table class="table table-bordered">
          ...
          ?>
            <tr style="text-align:center">
              ...
              <?php 
            if($row_donhang['huydon'] == 1) {
              $sql_select_khachhang1 = mysqli_query($con,"DELETE * FROM tbl_giaodich WHERE tbl_giaodich.huydon = '1' AND tbl_giaodich.magiaodich = '$magiaodich' ");
            }
          ?>
            </tr>
            <?php
