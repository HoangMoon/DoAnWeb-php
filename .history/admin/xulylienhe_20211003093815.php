      ...
      <?php 
        if(isset($_GET['quanly'])=='lienhe') {
          ...
          <div class="form-group col-md-12">
            <input type="text" style="width: 50%" name="email" class="form-control" id="" placeholder="Email...">
            <input type="text" name="subject" style="width: 50%"  class="form-control" id="" placeholder="Tiêu đề">
          </div>
          <br>
          <div class="form-group col-md-12">
