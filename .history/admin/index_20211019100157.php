...
<?php 
  if(isset($_POST['dangky'])) {
    ...
    $sql_dangky = mysqli_query($con, "INSERT INTO `tbl_admin`(`email`, `password`, `admin_name`) VALUES ('$emai1','$password1','$name')");
...
">
    ...
    <form action="" method="POST" class="form none" id="form" autocomplete="off">
            ...
            <div class="form-control2">
                ...
                <input type="password" name="" id="password2" placeholder="Password two">
                <i class="fa fa-eye icon-eye1" aria-hidden="true"></i>
                <small class="error-txt">Error message</small>
            </div>
            <button type="submit" name="dangky" class="sub-form">Submit</button>
        </form>
