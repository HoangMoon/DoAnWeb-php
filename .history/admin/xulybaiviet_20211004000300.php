      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr style="text-align:center">
            ...
            <td style="text-align: center;"><a style="font-size: 14px;width: 100px;" href="?xoa=<?php echo $row_bv['baiviet_id'] ?>" class="btn btn-danger">Xóa</a> <a href="xulybaiviet.php?quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>" style="width: 100px; font-size: 14px" class="btn btn-warning">Cập nhật</a></td>
          </tr>
          <?php
          }
          ?>
