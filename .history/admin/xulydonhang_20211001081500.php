      ...
      <table class="table table-bordered">
        ...
        ?> -->
          <tr>
            ...
            <td><?php echo $row_donhang['category_name'] ?></td>
            <td style="width: 200px"><a href="?xoa=<?php echo $row_donhang['category_id'] ?>" class="btn btn-danger">Xóa</a> || <a href="?quanly=capnhat&id=<?php echo $row_donhang['category_id'] ?>" class="btn btn-warning">Cập nhật</a></td>
          </tr>
          <?php
          }
          ?>
