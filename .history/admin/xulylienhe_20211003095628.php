...
if(isset($_POST['header']) && isset($_POST['email'])){
    ...
    require_once "php smtp/PHPMailer.php";
    require_once "php  smtp/SMTP.php";
    require_once "php  smtp/Exception.php";
    ...
    //email settings
    $mail->isHTML(true);
    $mail->setFrom($email, $header);
    $mail->addAddress("nguyenhuyhoang05082001@gmail.com");
