      ...
      <?php 
        if(isset($_GET['quanly'])=='lienhe') {
          ...
          <div class="form-group col-md-12">
            <input type="text" name="email" class="form-control col-md-6" id="" placeholder="Email...">
            <input type="text" name="subject" class="form-control col-md-6" id="" placeholder="Tiêu đề">
          </div>
          <div class="form-group col-md-12">
            <input type="text" name="header" id="" placeholder="Nội dung">
          </div>
          <div class="form-group col-md-12">
            <textarea name="message" id="" cols="30" rows="10">Ghi chú</textarea>
          </div>
          <button type="submit" name="sb-form" class="btn-contact">Gửi khách hàng</button>
        </form>
          </div>
          <?php
        }
