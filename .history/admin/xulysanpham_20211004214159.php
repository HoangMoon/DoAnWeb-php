...
<?php
  if(isset($_POST['themsanpham'])) {
    ...
    if($hinhanh1 = '') {
      ...
      move_uploaded_file($hinhanh_tmp2, $path.$hinhanh2);
      move_uploaded_file($hinhanh_tmp3, $path.$hinhanh3);
      $sql_update_image = "UPDATE tbl_sanpham SET sanpham_name = '$tensanpham',sanpham_chitiet = '$chitiet',sanpham_mota = '$mota',sanpham_gia = '$gia',sanpham_giakhuyenmai = '$giakhuyenmai',sanpham_soluong = '$soluong', sanpham_img1 = '$hinhanh2', sanpham_img2 = '$hinhanh3' ,category_id= '$danhmuc'  WHERE sanpham_id = '$id_update'";
    }
