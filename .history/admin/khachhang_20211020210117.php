    ...
    <div class="container body">
      ...
      ?>
        <table class="table table-bordered">
          ...
          <?php 
            if($row_khachhang['huydon'] == 1) {
              $sql_select_khachhang1 = mysqli_query($con,"DELETE * FROM tbl_khachhang,tbl_giaodich WHERE tbl_khachhang.khachhang_id = tbl_giaodich.khachhang_id GROUP BY tbl_giaodich.magiaodich  ORDER BY tbl_khachhang.khachhang_id DESC");
            }
          ?>
            </tr>
            <?php
