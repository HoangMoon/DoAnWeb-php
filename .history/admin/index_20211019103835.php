...
">
    ...
    <form action="index.php" method="POST" class="form none" id="form" autocomplete="off">
...
createLogin.addEventListener("submit", function(e){
  e.preventDefault();
  createLogin.classList.add("block")
  createLogin.classList.remove("none");
