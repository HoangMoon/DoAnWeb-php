      ...
      <?php 
        if(isset($_GET['quanly'])=='lienhe') {
          ...
          <div class="form-group col-md-12">
            <input type="text" name="email" class="form-control col-md-8 mr-2" id="" placeholder="Email...">
            <input type="text" name="subject" class="form-control col-md-4" id="" placeholder="Tiêu đề">
          </div>
          <br>
          <div class="form-group col-md-12">
