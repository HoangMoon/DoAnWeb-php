        ...
        <div class="right_col" role="main">
          <div class="row">
            <div class="statistical">
              ...
              ?>
              <?php 
                $sql_doanhthu = mysqli_query($con, "SELECT tbl_donhang.soluong , tbl_sanpham.sanpham_giakhuyenmai FROM tbl_donhang,tbl_sanpham WHERE tbl_donhang.sanpham_id = tbl_sanpham.sanpham_id");
                $total = 0;
                while($row_dt = mysqli_fetch_array($sql_doanhthu)) {
                  $subtotal =  number_format($row_dt['soluong']*$row_dt['sanpham_giakhuyenmai']).'vnđ';
									// $total += $subtotal;
              ?>
              <div class="list-statis money-total">
              <i class="fa fa-line-chart" aria-hidden="true"></i>
              <div class="feed-number">
                <span class="number-txt"><?php echo  number_format($subtotal).'vnd' ?></span>
