      ...
      <table class="table table-bordered">
        ...
        ?> -->
          <tr>
            ...
            <td style="width: 200px"><a href="?xoa=<?php echo $row_donhang['category_id'] ?>" class="btn btn-danger">Xóa</a> || <a href="?quanly=capnhat&id=<?php echo $row_donhang['category_id'] ?>" class="btn btn-primary">Xem đơn hàng</a></td>
          </tr>
          <?php
          }
          ?>
