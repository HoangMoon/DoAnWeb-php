           ...
           <div class="col-md-4">
            ...
            <form action="" method="POST" enctype='multipart/form-data'>
             <label for="">Tên sản phẩm</label>
              ...
              <textarea name="mota" class="form-control" value="<?php echo $row_capnhat['sanpham_mota'] ?>"></textarea>
              <br>
              <label for="">Chi tiết</label>
              <textarea name="chitiet" class="form-control" value="<?php echo $row_capnhat['sanpham_chitiet'] ?>"></textarea>
              <br>
